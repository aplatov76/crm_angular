...
export const cmOrdersFeatureSelectors = createFeatureSelector<
  AppStateInterface,
  OrderCmStateInterface
>('cmorders');
...
export const isCurrentOrderDataCount = createSelector(
  cmOrdersFeatureSelectors,
  (productsState: OrderCmStateInterface) =>
    productsState.currentOrder || null
);
