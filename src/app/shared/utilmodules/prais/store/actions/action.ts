...
export const praisActionSuccess = createAction(
  ActionTypes.PRAIS_SUCCESS,
  props<{ prais: PraisInterface[] }>()
);
export const praisActionFailed = createAction(
  ActionTypes.PRAIS_FAILURE
);
...
export const productActionSuccess = createAction(
  ...
  props<{ currentProduct: ProductInterface }>()
);
