...
export const addOrderAction = createAction(ActionTypes.ADD_ORDER, props<{createOrder: CreateOrderInterface}>());
export const addOrderActionSuccess = createAction(ActionTypes.ADD_ORDER_SUCCESS, props<{order: OrderInterface}>());
export const addOrderActionFailed  = createAction(ActionTypes.ADD_ORDER_FAILURE, props<{err: ErrorMessageInterface}>());