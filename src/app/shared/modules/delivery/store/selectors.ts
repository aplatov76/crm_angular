...
export const deliverysFeatureSelectors = createFeatureSelector<
  AppStateInterface,
  DeliverysStateInterface
>('delivery');

export const isDeliverys = createSelector(
  deliverysFeatureSelectors,
  (deliverysState: DeliverysStateInterface) =>
    deliverysState.deliverys
);
...
export const currentDelivery = createSelector(
  deliverysFeatureSelectors,
  (deliverysState: DeliverysStateInterface) =>
    deliverysState.currentDelivery
);
